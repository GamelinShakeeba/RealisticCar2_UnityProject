...
{
    public int countToBreakWingL = 0;
    ...
    public void DetachWingL()
    {
        Destroy(hingeJoint);
        transform.position += Vector3.down * detachForce * Time.deltaTime;
        StartCoroutine(DestroyWingL());
    }

    IEnumerator DestroyWingL()
    {
