...
{
    public int countToBreakFrontBumper = 0;
    ...
    public void DetachFB()
    {
        Destroy(hingeJoint);
        transform.position += Vector3.down * detachForce * Time.deltaTime;
        StartCoroutine(DestroyFB());
    }

    IEnumerator DestroyFB()
    {
