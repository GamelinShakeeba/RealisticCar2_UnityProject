...
{
    public int countToBreakWingR = 0;
    ...
    public void DetachWingR()
    {
        Destroy(hingeJoint);
        transform.position += Vector3.down * detachForce * Time.deltaTime;
        StartCoroutine(DestroyWingR());
    }

    IEnumerator DestroyWingR()
    {
